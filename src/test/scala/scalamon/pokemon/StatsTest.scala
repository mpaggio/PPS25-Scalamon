...
class StatsTest extends AnyFunSuite:
  ...
  test("Stats creation should fail if at least one of the other statistics is a negative value") {
    a[IllegalArgumentException] should be thrownBy Stats(hp = 39, attack = -1, defense = 43, specialAttack = 60, specialDefense = 50, speed = 65)
    a[IllegalArgumentException] should be thrownBy Stats(hp = 39, attack = -1, defense = 0, specialAttack = -60, specialDefense = 0, speed = -65)
  }
