...
object MyPokedex:
  ...
  val allPokemons: List[Pokemon] = Pokedex(
    ...
    Category(Water)(
      "Squirtle" id 7 stats(44, 48, 65, 50, 64, 43) ability Torrent withHiddenAbility EarlyBird,
    ...
    Category(Grass)(
      ...
      "Bellsprout" id 69 stats(50, 75, 35, 70, 30, 40) ability Gluttony withHiddenAbility Chlorophyll,
    ...
    Category(Electric)(
      ...
      "Electabuzz" id 125 stats(65, 83, 57, 95, 85, 105) ability Static withSecondaryAbility VitalSpirit,
    ...
    Category(Psychic)(
      ...
      "Mewtwo" id 150 stats(106, 110, 90, 154, 90, 130) ability Pressure withHiddenAbility Unnerve,
    ...
    Category(Poison)(
      ...
      "Grimer" id 88 stats(80, 80, 50, 40, 50, 25) ability StickyHold withSecondaryAbility PoisonTouch,
