 ...
 * @param hidden an optional hidden ability that a Pokémon may have, which is mutually
 * exclusive with the secondary ability.
 * @throws IllegalArgumentException if both a secondary and a hidden
 * ability are assigned simultaneously.
 */
