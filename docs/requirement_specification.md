...
Nel caso in cui entrambi i giocatori scelgano di eseguire una stessa azione (a pari priorità di base), l'ordine deve essere determinato confrontando la velocità dei Pokémon coinvolti: il Pokémon con velocità maggiore deve agire per primo. Ogni evento significativo generato durante la risoluzione deve aggiornare correttamente lo stato della battaglia e produrre un messaggio nei log.
